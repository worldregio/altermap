...
mf_map(map, type="base", col="lightyellow")
mf_map(tabreg, type="base", col="blue", add=T, border="red",alpha=0.03)
...
En se limitant pour l'instant aux 15 étudiants du groupe 4 : 

#### Superposition de tous les découpages
...
mf_layout(title = "Découpages des étudiants du groupe 4 / Enxemble",
...
mf_map(sel, type="base", col="red", add=T, border="blue",alpha=0.1,lwd=1)
